...
<p>Currently at <a href="https://x.company/" target="_blank" rel="noopener noreferrer">Google [X], the moonshot factory</a>, I build AI researchers — agentic systems that self-improve and drive scientific discovery end-to-end — for an undisclosed project in finance and decarbonization.</p>
